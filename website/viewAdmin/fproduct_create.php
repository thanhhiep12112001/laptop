                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Form Create Product</h6>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" name="idproduct" 
                                    placeholder="name@example.com" required>
                                <label for="floatingInput">Mã sp</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword" name="ten" 
                                    placeholder="text" required>
                                <label for="floatingPassword">Tên sp</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingPassword" name="gia" required>
                                <label for="floatingPassword">Giá</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingPassword" name="gia_km" required>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect" name="idcat"
                                    ...
                                    ?>
                                    <option value="<?php echo $item['idcat'] ?>" >
