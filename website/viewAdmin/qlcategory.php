                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <h6> Số danh mục là: <?php echo $n ?></h6>
                            <div class="row">
                                <form action="category.php" method='get' class="d-none d-md-flex">
                                    <div class="col-md-9">
                            ...
                            <br>
                            <div>
                                <a href="cate_create.php" class="btn btn-primary">Thêm</a>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="cate_edit.php?id=<?php echo $item['idcat'] ?>" class="btn btn-primary">sửa</a>
                                            </td>
                                            <td>
                                                <a href="cate_delete.php?id=<?php echo $item['idcat'] ?>" class="btn btn-danger">xóa</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
