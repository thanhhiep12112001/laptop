                        ...
                        ?>
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        <p class="product-category">Category</p>
                                        <h3 class="product-name"><a href="detail.php?id=<?php echo $item['idproduct'] ?>"><?php echo $item['ten'] ?></a></h3>
                                        <h4 class="product-price"><?php echo number_format($item['gia_km']) ?>Đ <del class="product-old-price"><?php echo number_format($item['gia']) ?>Đ</del></h4>
