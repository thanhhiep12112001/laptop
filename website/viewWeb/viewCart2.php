        ...
        <div class="row">
            ...
            <form action="checkout.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $_SESSION['user']['hoten'] ?>" name="hoten">
                </div>
                <div class="form-group">
                    <label for="">Địa chỉ người nhận</label>
                    <input type="text" class="form-control" value="<?php echo $_SESSION['user']['diachi'] ?>" name="diachi">
                </div>
                <div class="form-group">
                    <label for="">SĐT người nhận</label>
                    <input type="text" class="form-control" value="<?php echo $_SESSION['user']['sdt'] ?>" name="sdt">
                </div>
